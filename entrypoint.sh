...
# hadoop jar /hadoop/share/hadoop/tools/lib/hadoop-streaming-3.3.6.jar -files "/app/scripts/mapper.py,/app/scripts/reducer.py" -mapper "python3 mapper.py" -reducer "python3 reducer.py" -input "hdfs://localhost:9000/var/log/alternatives.log" -output "/hadoop-output/Wordcount"
